...
export function Header({ title, showBack = true, rightAction }: HeaderProps) {
  ...
  return (
    <header className="fixed top-0 w-full md:left-64 md:w-[calc(100%-16rem)] z-50 bg-bg-light/95 dark:bg-bg-dark/95 backdrop-blur-md border-b border-gray-200 dark:border-gray-800">
