  ...
  const projectSPPS = await prisma.project.create({
    data: {
      ...
      ticker: "SPPS",
        ...
        plans: [
          { name: "Retail", apy: 12.0, min: 5, term: 19, lockup: "6 months", payout: "Semi-Annual", badge: "Popular", description: "Standard access to harvest cycle returns" },
  ...
  const projectMDD = await prisma.project.create({
    data: {
      ...
      ticker: "MDD",
        ...
        plans: [
          { name: "Retail", apy: 11.8, min: 5, term: 24, lockup: "12 months", payout: "Quarterly", badge: "Popular", description: "Standard access with milestone-gated capital protection" },
  ...
  const projectKBB = await prisma.project.create({
    data: {
      ...
      ticker: "KBB",
        ...
        plans: [
          { name: "Flex 12-Month", apy: 12.5, min: 5, term: 12, lockup: "3 months", payout: "Monthly", badge: null, description: "Shorter commitment with flexible redemption" },
          { name: "Standard 18-Month", apy: 14.5, min: 5, term: 18, lockup: "6 months", payout: "Monthly", badge: "Popular", description: "Full-term access to clinic cashflow returns" },
    ...
    data: [
      {
        ...
        plans: [
          { name: "Founders Close Preferred", apy: 15.0, min: 5, term: 36, lockup: "12 months", payout: "Quarterly", badge: "Founders 25%+ Uplift", description: "Priority waterfall position + enhanced yield for early investors" },
          { name: "Base Note", apy: 12.0, min: 5, term: 36, lockup: "12 months", payout: "Quarterly", badge: null, description: "Standard access to waste processing revenue" },
        ],
      },
      {
        ...
        plans: [
          { name: "PIT Standard", apy: 10.5, min: 5, term: 24, lockup: "6 months", payout: "Quarterly", badge: "Popular", description: "Quarterly net-rent income from diversified property portfolio" },
          { name: "PDN Development", apy: 14.0, min: 5, term: 24, lockup: "12 months", payout: "Quarterly", badge: "Best Value", description: "Development upside + capital appreciation returns" },
          { name: "PIT Pro", apy: 11.5, min: 5, term: 24, lockup: "6 months", payout: "Quarterly", badge: "Pro", description: "Priority redemption + dedicated portfolio manager" },
        ],
      },
    ],
  });
